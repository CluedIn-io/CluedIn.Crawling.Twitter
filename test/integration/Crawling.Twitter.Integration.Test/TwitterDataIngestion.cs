...
{
    public class DataIngestion : IClassFixture<TwitterTestFixture>
    {
        private readonly TwitterTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(TwitterTestFixture fixture, ITestOutputHelper output)
        {
