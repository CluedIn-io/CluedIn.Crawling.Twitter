...
{
    public class Twitter_Command_MeshProcessor : BaseMeshProcessor
    {
        public Twitter_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          TwitterConstants.ProviderId;
