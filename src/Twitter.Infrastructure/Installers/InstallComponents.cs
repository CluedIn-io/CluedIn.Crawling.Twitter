...
namespace CluedIn.Crawling.Twitter.Infrastructure.Installers
{
    public class InstallComponents : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            container
                ...
                .Register(Component.For<ITwitterClientFactory>().AsFactory())
                .Register(Component.For<TwitterClient>().LifestyleTransient());
